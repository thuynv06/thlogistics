...
//                            $data = base64_decode($img);
                ...
                $tiencong = ($tongtienhangweb + $tongtienshiptq) * $phidichvu;
                $tongall = ($tongtienhangweb + $tongtienshiptq + $tiencong - $tongmagiamgia) * $tygiate + $tienvanchuyen;

//                echo (print_r($listproduct,true));
//                echo $phidichvu;
                $orderId = $orderRepository->createOrder($userCode, $listproduct, $tygiate, $phidichvu, $giavanchuyen, $tongtienhangweb, $tongtienshiptq, $tienvanchuyen, $tamung, $tongall, $tiencong, $tongmagiamgia,$tongcan);
