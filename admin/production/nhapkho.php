...
?>
    ...
    <div class="right_col" role="main">
                ...
                <div class=" " style="padding: 20px;">
                    <form action="importKG.php" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group">
                                <label><span
                                            style="color: #0b0b0b;font-weight: 700;margin-right: 10px;font-size: 16px;">Upload File Ký Gửi:</span></label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label style="color: #0b0b0b;font-weight: 700;margin-right: 10px;font-size: 16px;">Vận
                                    Đơn Cho Khách Hàng</label>
                            ...
                            <?php //echo $th1688['giavanchuyen'] ?><!--"-->
                            <!--                                   placeholder="Nhập giá tiền">-->
                            <!--                        </div>-->
                            <div class=" form-group col-md-6">
                                <label style="color: #0b0b0b;font-weight: 700;margin-right: 10px;font-size: 16px;">Ngày
                                    Nhập</label>
                                <input value="" name="ngaynhap" type="datetime-local" step="1"
        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                <div class=" " style="padding: 20px;">
                    <form action="chuyentrangthai.php" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group">
                                <label><span
                                            style="color: #0b0b0b;font-weight: 700;margin-right: 10px;font-size: 16px;">Upload Danh Sách MVD</span></label>
                                <input required type="file" name="file">
                                <p style="font-size: 14px;">Tải file excel mẫu tại <a style="color: blue;"
                                                                                      href="../production/uploads/filemauKHKG.xlsx">đây</a>
                                </p>
                        ...
                        <div class="form-group">
                            <label style="color: #0b0b0b;font-weight: 700;margin-right: 10px;font-size: 16px;">Chuyển Trạng Thái</label>
                        ...
                        <div class="form-row">
                            <div class=" form-group col-md-6">
                                <label style="color: #0b0b0b;font-weight: 700;margin-right: 10px;font-size: 16px;">Ngày Cập Nhập</label>
                                <input value="" name="ngaycapnhap" type="datetime-local" step="1"
                                       class="form-control" id="ngaycapnhap">
                            </div>
                        </div>
                        <button class="btn btn-primary" type="submit" name="btnImportKG">Cập Nhập</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <?php //echo $mvd['cannang'] ?><!--<span> /Kg</span></td>-->
        <!--                    <td>--><?php //echo product_price($mvd['giavc']) ?><!--</td>-->
        <!--                    <td style="font-weight: 800;color: blue">-->
        <?php //echo product_price($mvd['thanhtien']) ?><!--</td>-->
        <!--                    <td>-->
        ...
        <?php //if (!empty($obj->{1})) echo $obj->{1}; ?><!--</li>-->
        <!--                                <li><p class="fix-status">-->
        <?php //if (!empty($obj->{2})) echo $obj->{2}; ?><!--</p></li>-->
        <!--                                <li><p class="fix-status">-->
        <?php //if (!empty($obj->{3})) echo $obj->{3}; ?><!--</p></li>-->
        <!--                                <li><p class="fix-status">-->
        <?php //if (!empty($obj->{4})) echo $obj->{4}; ?><!--</p></li>-->
        <!--                                <li><p class="fix-status">-->
        <?php //if (!empty($obj->{5})) echo $obj->{5}; ?><!--</p></li>-->
        <!--                            </ul>-->
        <!--                            --><?php
        //                        } ?>
        <!--                    </td>-->
    ...
    <script>
        ...
        document.getElementById('ngaycapnhap').value = timestampToDatetimeInputString(Date.now());
