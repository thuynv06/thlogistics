        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12">
                    <p>Thương Mại Điện Tử Trung Việt - KĐT Mới Văn Khê - Hà Đông - Hà Nội - Hotline: 033.699.1688 -----Tỷ giá: 1¥ = <?php echo $th['tygia'] ?> </p>
                </div>
...
<div class="header-services">
    <div class="row">
        <div class="ps-services owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="3000"
            ...
            <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Thương Mại Điện Tử Trung Việt</strong>: Giải pháp đột phá tiết
                kiệm chi phí</p>
            <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Thương Mại Điện Tử Trung Việt</strong>: Dẫn đầu về tốc độ</p>
            <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Thương Mại Điện Tử Trung Việt</strong>: Đặt hàng không qua
